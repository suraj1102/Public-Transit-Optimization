...
def get_bus_stops_within_buffer(center_point, buffer_radius_km):
    ...
    bus_stops = pd.read_csv("scarping_scripts/scarped_data/processed_data/bus_stop_locations.csv")
...
traffic_data_files = [
    ...
    # "traffic_data/2025-03-19_13-28-11.json", "19th March 8 am"
...
for metric in metrics:
    ...
    for i in range(0, len(traffic_data_files), 2):
        ...
        plot_graph_and_bus_stops(ax=ax, graph=graph, sector_labels=False, bus_stops=False, show_center_point=True)
